...
function App() {
  ...
  useEffect(() => {
    if (!supabase) {
      // No Supabase configured — skip auth, run app directly
  ...
  if (authLoading) {
    return (
      <div className="app app--glassy" style={{ justifyContent: "center", alignItems: "center" }}>
        <motion.div
          ...
          >
            ...
            {supabase && (
              <button
                ...
                onMouseLeave={(e) => {
                  e.currentTarget.style.color = "var(--text-dim, rgba(255,255,255,0.35))";
