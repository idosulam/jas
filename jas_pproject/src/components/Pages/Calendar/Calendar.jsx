            ...
            >
              ...
              {laidOutEvents.map((event) => {
                ...
                return (
                  <article
                    key={event.id}
                    className={`calendar__event calendar__event--${event.color}${event.is_completed ? " calendar__event--done" : ""}`}
                    style={{
                      ...style,
      ...
      {events.length > 0 && (
        <ul className="calendar__reminders animate-in animate-in--4">
          {events.map((event) => (
            <li
              key={`list-${event.id}`}
              className={`calendar__reminder${event.is_completed ? " calendar__reminder--done" : ""}`}
            >
              <button
                type="button"
        ...
        >
          ...
          >
            ...
            <p className="calendar__delete-desc">
              <strong>{deleteTarget.title}</strong> on {deleteTarget.event_date}{" "}
